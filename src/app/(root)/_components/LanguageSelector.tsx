  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className={`w-full group relative flex items-center gap-3 px-4 py-2.5 bg-[#1e1e2e]/80 
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute w-full md:w-fit top-full left-0 mt-2 bg-[#1e1e2e]/95 backdrop-blur-xl
              ...
              {Object.values(LANGUAGE_CONFIG).map((lang, index) => {
                ...
                return (
                  ...
                  >
                    <button
                      className={`
                    relative w-full md:w-64 flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200
